...
export class UpgradeCDKTF {
  constructor(project: javascript.NodeProject) {
    ...
    workflow.on({
      schedule: [{ cron: "35 */6 * * *" }], // Runs four times a day
          ...
          },
          {
            ...
            with: {
              ...
              body: [
                ...
                " ",
                "- [ ] Update `@cdktf/provider-null` to a version compatible with `cdktf@${{ steps.latest_version.outputs.value }}` [here](https://github.com/cdktf/cdktf-tf-module-stack/blob/106036d2d6b65652b68dabb2648b1f7980c6421d/.projenrc.ts#L78). Look up the version [here](https://github.com/cdktf/cdktf-provider-null/releases/).",
                "- [ ] Update `@cdktf/provider-random` to a version compatible with `cdktf@${{ steps.latest_version.outputs.value }}` [here](https://github.com/cdktf/cdktf-tf-module-stack/blob/106036d2d6b65652b68dabb2648b1f7980c6421d/.projenrc.ts#L79). Look up the version [here](https://github.com/cdktf/cdktf-provider-random/releases/).",
                "- [ ] Run `npx projen`",
                " ",
